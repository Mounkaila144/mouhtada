...
export default function prixStock({articles}) {
    ...
    const Searche = async () => {
        await MyRequest('historique/prix?nom=' + search, 'GET', {}, { 'Content-Type': 'application/json' })
            .then((response) => {
                            ...
                            {article.map((articles) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell>{articles.prixAchat} CFA</TableCell>
